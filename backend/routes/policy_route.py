...
from schemas.policy_schemas import PlanResponse, PolicyCreate, PolicyResponse
from services.auth_service import get_current_user
from services.policy_service import buy_policy, get_my_policy, get_plans
...
@router.get("/my-policy", status_code=200, response_model=PolicyResponse)
